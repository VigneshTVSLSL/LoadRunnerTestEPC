Action()
{
	...
	web_add_cookie("_ga=GA1.2.118714384.1558522398; DOMAIN=epc2017-itg-beta.msys.parts");

	web_add_cookie("_gid=GA1.2.748241074.1558522398; DOMAIN=epc2017-itg-beta.msys.parts");
